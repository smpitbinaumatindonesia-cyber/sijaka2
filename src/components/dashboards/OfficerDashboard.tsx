    ...
    <div className="space-y-8 font-sans max-w-6xl mx-auto animate-in fade-in duration-300">
      ...
      <div className="rounded-3xl p-6 sm:p-8 bg-[#0B1428] border border-slate-800 shadow-xl space-y-4">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-slate-800 pb-4">
          ...
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-blue-500/10 border border-blue-500/20 text-blue-300 text-xs sm:text-sm font-bold self-start sm:self-center shrink-0">
      ...
      <div className="p-5 sm:p-6 rounded-2xl bg-[#0B1428] border border-amber-500/40 shadow-sm space-y-4">
        <div className="flex items-center justify-between border-b border-slate-800 pb-3">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h2 className="text-base sm:text-lg font-bold text-white">Butuh Tindakan Hari Ini</h2>
              <p className="text-xs sm:text-sm text-slate-400">Tugas operasional yang memerlukan aksi pengurus</p>
            </div>
          </div>

          <span className="text-xs sm:text-sm font-bold px-3 py-1 rounded-full bg-amber-500/10 text-amber-300 border border-amber-500/30">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
          ...
          <div className="p-4 rounded-xl bg-slate-900/70 border border-slate-800 flex flex-col justify-between gap-3">
            ...
            <button
              ...
              className="w-full py-2 rounded-lg bg-rose-600 hover:bg-rose-500 text-white font-bold text-xs sm:text-sm transition-all min-h-[38px]"
            >
          ...
          <div className="p-4 rounded-xl bg-slate-900/70 border border-slate-800 flex flex-col justify-between gap-3">
            ...
            <button
              ...
              className="w-full py-2 rounded-lg bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-xs sm:text-sm transition-all min-h-[38px]"
            >
              Catat Iuran Masuk
            </button>
          </div>
          ...
          <div className="p-4 rounded-xl bg-slate-900/70 border border-slate-800 flex flex-col justify-between gap-3">
            ...
            <button
              ...
              className="w-full py-2 rounded-lg bg-blue-600 hover:bg-blue-500 text-white font-bold text-xs sm:text-sm transition-all min-h-[38px]"
            >
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="p-5 sm:p-6 rounded-2xl bg-[#0B1428] border border-slate-800 space-y-1.5">
          ...
          <div className="text-xs text-slate-400 font-medium">RT 06, 07, & 10</div>
        </div>

        <div className="p-5 sm:p-6 rounded-2xl bg-[#0B1428] border border-slate-800 space-y-1.5">
          <div className="text-xs sm:text-sm text-slate-400 font-semibold">Iuran Masuk</div>
          <div className="text-2xl sm:text-3xl font-bold text-emerald-400 font-mono">
            {formatRupiah(summaryKas.masuk)}
          </div>
          <div className="text-xs text-slate-400 font-medium">Akumulasi Kas Masuk</div>
        </div>

        <div className="p-5 sm:p-6 rounded-2xl bg-[#0B1428] border border-slate-800 space-y-1.5">
          <div className="text-xs sm:text-sm text-slate-400 font-semibold">Santunan Keluar</div>
          <div className="text-2xl sm:text-3xl font-bold text-rose-400 font-mono">
            {formatRupiah(summaryKas.keluar)}
          </div>
          <div className="text-xs text-slate-400 font-medium">{kematianList.length} Musibah Tersalurkan</div>
        </div>

        <div className="p-5 sm:p-6 rounded-2xl bg-[#0B1428] border border-slate-800 space-y-1.5">
          <div className="text-xs sm:text-sm text-slate-400 font-semibold">Saldo Operasional</div>
          <div className="text-2xl sm:text-3xl font-bold text-blue-400 font-mono">
            {formatRupiah(summaryKas.saldo)}
          </div>
          <div className="text-xs text-emerald-400 font-semibold">Kas Siap Salur</div>
        </div>
      </div>
          ...
          <div className="bg-[#0B1428] border border-slate-800 rounded-2xl p-5 sm:p-6 shadow-sm space-y-4">
            <div className="flex items-center justify-between border-b border-slate-800 pb-3">
              <div className="flex items-center gap-2">
                <Heart className="w-4 h-4 text-rose-400" />
                <h3 className="text-base sm:text-lg font-bold text-white">Laporan Musibah Terbaru</h3>
              </div>
            ...
            {kematianList.length === 0 ? (
              ...
              <div className="space-y-2">
                {kematianList.slice(0, 3).map((item, idx) => (
                  <div key={item.id_laporan || idx} className="p-3.5 rounded-xl bg-slate-900/50 border border-slate-800 flex items-center justify-between text-xs sm:text-sm">
                    ...
                    <div className="text-right">
                      <span className="inline-flex items-center px-2 py-0.5 rounded text-xs font-bold bg-emerald-500/10 text-emerald-300 border border-emerald-500/30">
                        {item.status || 'Tersalurkan'}
                      </span>
                      <div className="text-xs text-slate-400 mt-0.5 font-mono">Rp 2.500.000</div>
                    </div>
                  </div>
                ))}
              </div>
        ...
        <div className="lg:col-span-6">
          <div className="bg-[#0B1428] border border-slate-800 rounded-2xl p-5 sm:p-6 shadow-sm space-y-4">
            <div className="flex items-center justify-between border-b border-slate-800 pb-3">
              <div className="flex items-center gap-2">
                <DollarSign className="w-4 h-4 text-emerald-400" />
                <h3 className="text-base sm:text-lg font-bold text-white">Pencatatan Iuran Kas Terbaru</h3>
              </div>
                ...
                {iuranList.slice(0, 3).map((item, idx) => (
                  <div key={item.id_iuran || idx} className="p-3.5 rounded-xl bg-slate-900/50 border border-slate-800 flex items-center justify-between text-xs sm:text-sm">
                    <div className="space-y-0.5">
                      ...
                      <div className="text-xs text-slate-400">{item.tanggal || 'Tercatat'}</div>
                    </div>
                    ...
                    <div className="text-right">
                      ...
                      <span className="text-xs text-slate-400">Kas Masuk</span>
                    </div>
                  </div>
                ))}
              </div>
